		...
		<div class="stuffbox">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
				...
				<tr class="heateor_help_content" id="heateor_sc_fb_comment_lang_help_cont">
					<td colspan="2">
					<div>
					<?php echo sprintf(__('Enter the code of the language you want to use to display commenting. You can find the language codes at <a href="%s" target="_blank">this link</a>. Leave it empty for default language(English)', 'heateor-social-comments'), 'http://fbdevwiki.com/wiki/Locales#Complete_List_.28as_of_2012-06-10.29') ?>
					</div>
					</td>
				</tr>
			</table>
		...
		<div class="stuffbox">
			...
			<div class="inside">
				<p><?php _e( '<strong>Note:</strong>', 'heateor-social-comments' ) ?>
					<br/>1. <?php _e( 'Plugin will not work on local server. You should have an online website for the plugin to function properly.', 'heateor-social-comments' ) ?>
					<br/>2. <?php _e( 'Default comment form must be enabled at the webpages where you want social comments to work.', 'heateor-social-comments' ) ?>
				</p>
				<p></p>
